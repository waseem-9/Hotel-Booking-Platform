...
{/* <div class="mt-2">
<div className="card form-card border-color custom-bg mb-3 " style={{ maxHeight: '800px', overflow: 'hidden' }}>
  <HotelCarousel 
    item={{
      image1: hotel.image1,
      image2: hotel.image2,
  ...
  <div class="card form-card border-color custom-bg mb-3">
    <div class="card-header bg-color">
      <div className="d-flex justify-content-between">
        <h1 className="custom-bg-text">{hotel.name}</h1>
      </div>
...
<div style={{ marginTop: '20px' }}>
  <div className="card" style={{ border: '1px solid #e0e0e0', borderRadius: '10px', backgroundColor: '#ffffff', marginBottom: '20px', maxHeight: '800px', overflow: 'hidden', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
    <HotelCarousel 
      item={{
        image1: hotel.image1,
        image2: hotel.image2,
  ...
  <div className="card" style={{ border: '1px solid #e0e0e0', borderRadius: '10px', backgroundColor: '#ffffff', marginBottom: '20px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
    <div className="card-header" style={{ backgroundColor: '#80AF81', color: '#fff', borderRadius: '10px 10px 0 0', padding: '15px' }}>
      <div className="d-flex justify-content-between">
        <h1 style={{ margin: 0 }}>{hotel.name}</h1>
      </div>
    </div>

    <div className="card-body" style={{ color: '#333', padding: '20px' }}>
      <div className="mt-3">
        <h3>Description :</h3>
      </div>
      <h4 className="card-text" style={{ fontWeight: 'normal', lineHeight: '1.6' }}>{hotel.description}</h4>
    </div>

    <div className="card-footer" style={{ backgroundColor: '#f1f1f1', borderRadius: '0 0 10px 10px', padding: '15px' }}>
      <div className="d-flex justify-content-between">
        <p style={{ margin: 0 }}>
          <h4 style={{ display: 'inline-block', margin: 0 }}>Price : &#8377;{hotel.pricePerDay}</h4>
        </p>
      ...
      <form className="row g-3" onSubmit={bookHotel}>
        <div className="col-auto">
          <label htmlFor="checkin" style={{ display: 'block', marginBottom: '5px' }}>Check-in</label>
          <input
            type="date"
            className="form-control"
            id="checkin"
            ...
            value={booking.checkIn}
            required
            style={{ borderRadius: '5px', padding: '10px', border: '1px solid #ccc' }}
          />
        </div>
        <div className="col-auto">
          <label htmlFor="checkout" style={{ display: 'block', marginBottom: '5px' }}>Check-out</label>
          <input
            type="date"
            className="form-control"
            id="checkout"
        ...
        <div className="col-auto">
          <label htmlFor="totalPerson" style={{ display: 'block', marginBottom: '5px' }}>Total Person</label>
          <input
            type="number"
            className="form-control"
            id="totalPerson"
        ...
        <div className="d-flex justify-content-center" style={{ marginTop: '10px' }}>
          <div>
            <input
              type="submit"
              className="btn"
              style={{ backgroundColor: '#007bff', color: '#fff', borderRadius: '5px', padding: '10px 20px', border: 'none' }}
              value="Book Hotel"
            />
            <ToastContainer />
          </div>
      ...
      {admin && (
        <div>
          <input
            type="submit"
            className="btn"
            style={{ backgroundColor: '#007bff', color: '#fff', borderRadius: '5px', padding: '10px 20px', border: 'none', marginTop: '10px' }}
            value="Add Facilities"
            onClick={navigateToAddHotelFacility}
          />
        </div>
  ...
  <h3 className="text-center" style={{ marginTop: '20px' }}>Hotel Room Booking Status</h3>

  <div className="d-flex aligns-items-center justify-content-center" style={{ marginTop: '20px' }}>
    <form className="row g-3">
      <div className="col-auto">
        <select
          onChange={(e) => setTempSelectedHotelRoomForStatus(e.target.value)}
          className="form-control"
          required
          style={{ borderRadius: '5px', padding: '10px', border: '1px solid #ccc' }}
        >
          <option value="">Select Hotel Room </option>
          {hotel.rooms.map((room) => (
            <option key={room.id} value={room.id + "_" + room.roomNumber}>
              Room {room.roomNumber}
            </option>
          ))}
        </select>
